...
public class main {
    ...
    public static void main(String [ ] args){
        ...
        Sale venta1 = new Sale(1,"25/5/2003",articleList,1);
        Sale venta2 = new Sale(2,"26/5/2003",articleList2,2);
...
*/
       ...
       // d.actualizarArticulo(new Article(
        //        "1","juju","yeye",5.01,31,
       //         "Arroz bomba",89));
       // System.out.println(d.obtenerArticulo("1"));
    }
}